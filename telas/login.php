<?php
include "processos/validaLogin.php"; ?> 
<!DOCTYPE html>
...
<body class="d-flex align-items-center text-center py-4 bg-body-tertiary">
  ...
  <!-- Botão de ativar/desativar modo escuro -->
  ...
  <main class="d-flex align-items-center justify-content-center w-100 flex-grow-1">
    <div class="col-12 col-md-6" style="max-width: 350px">
      <form action="" method="post">
        <h1 class="h3 mb-3 fw-normal">Bem-vindo(a)</h1>
        <p>
          O melhor aplicativo para organizar seus eventos e curtir a vida!
        </p>
        <div class="form-floating">
          <input type="text" class="form-control" style="margin-bottom: 2%" id="floatingInput" name="usuario"
            placeholder="Informe seu usuário" required autofocus />
        ...
        <a class="btn btn-primary w-100 py-2" style="background-color: grey; margin-top: 2%" type="submit"
          href="registro.php">
          Registrar-se
        </a>

        <p class="mt-5 mb-3 text-body-secondary">&copy; 2025 Find&Go</p>
      </form>
    </div>
  </main>
