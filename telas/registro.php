...
<html lang="pt-br" data-bs-theme="auto">
  ...
  <body class="bg-body-tertiary">
    ...
    <!-- Botão de Troca de Tema (Dark/Light) -->
    <div
    ...
    <div class="container">
      <main>
        <div class="row justify-content-center">
          <div class="col-md-12 col-sm-6 card p-4">
            <!-- Cabeçalho -->
            <div class="py-5">
              <!-- <img
                class="d-block mb-4"
                ...
                height="57"
              /> -->
              <h1 class="h2">Find&Go</h1>
              <h3 class="lead">
                <p>Cadastro</p>
              </h3>
            </div>
            <h4 class="mb-3">Preencha com suas informações.</h4>

            <form action="estaticos/inserir.php" method="post">
              <div class="row g-3">
                <div class="col-sm-6">
                  ...
                  <input
                    ...
                    required
                  />
                  <div class="invalid-feedback">Opção obrigatória.</div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group has-validation">
                    <input
                      ...
                      id="Usuário"
                      name="usuario"
                      placeholder="Fulano da Silva Silveira"
                    />
                    <div class="invalid-feedback">Um Usuário é necessário.</div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <div class="input-group has-validation">
                    ...
                    <input
                      ...
                      id="email"
                      name="email"
                      placeholder="fulano@examplo.com"
                    />
                    <div class="invalid-feedback">
                      Por favor escolha um endereço de email válido.
                    </div>
                  </div>
                </div>

                <div class="col-3">
                  <label for="dt-nascimento" class="form-label"
                    >Data de Nascimento
                    <span class="text-body-secondary"></span></label
                  >
                  <div class="input-group has-validation">
                ...
                <div class="col-12">
                  ...
                  <div class="input-group has-validation">
                    <input
                      ...
                      id="senha"
                      name="senha"
                      placeholder="Maisculas, números, etc."
                      required
                    />
                    <div class="invalid-feedback">Uma senha é necessária.</div>
                  </div>
                </div>
                ...
                <div class="col-12">
                  ...
                  <input
                    ...
                    id="endereço"
                    name="endereco"
                    placeholder="Avenida Cornelios, 1002"
                    required
                  />
                  <div class="invalid-feedback">
      ...
      <footer class="my-5 pt-5 text-body-secondary text-center text-small">
        <p class="mb-1">&copy; 2025 King Party</p>
